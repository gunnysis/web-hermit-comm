...
// Generated at: 2026-03-17T14:00:04Z
...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      block_user: { Args: { p_alias: string }; Returns: undefined }
      ...
      generate_display_alias: { Args: never; Returns: string }
      get_blocked_aliases: { Args: never; Returns: string[] }
      get_daily_activity_insights: { Args: { p_days?: number }; Returns: Json }
      ...
      get_same_mood_dailies: {
        Args: { p_emotions: string[]; p_post_id: number }
        Returns: Json
      }
      ...
      get_today_daily: { Args: never; Returns: Json }
      get_trending_posts: {
      ...
      get_yesterday_daily_reactions: { Args: never; Returns: Json }
      ...
      unblock_user: { Args: { p_alias: string }; Returns: undefined }
      update_daily_post: {
        Args: {
          p_activities?: string[]
          p_content?: string
